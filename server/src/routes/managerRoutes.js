...
import { getEmployees, getInventory, getDishes, updateEmployeeController } from "../controllers/managerController.js";
...
router.put("/employee/:employee_id", updateEmployeeController);
